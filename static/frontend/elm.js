...
var $author$project$Main$Model = F3(
	function (key, url, recipes) {
		return {key: key, recipes: recipes, url: url};
	});
var $author$project$Main$GotRecipes = function (a) {
...
var $author$project$Main$Recipe = function (id) {
...
var $author$project$Main$recipeDecoder = A3(
...
var $author$project$Main$getAllRecipes = $elm$http$Http$get(
	{
		expect: A2($elm$http$Http$expectJson, $author$project$Main$GotRecipes, $author$project$Main$recipeListDecoder),
		url: 'http://localhost:8000/api/recipes/'
	});
var $author$project$Main$init = F3(
	function (flags, url, key) {
		return _Utils_Tuple2(
			A3($author$project$Main$Model, key, url, $author$project$Main$Loading),
			$author$project$Main$getAllRecipes);
	});
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			default:
				var recipeResult = msg.a;
				if (recipeResult.$ === 'Err') {
					var error = recipeResult.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{recipes: $author$project$Main$Failure}),
						$elm$core$Platform$Cmd$none);
				} else {
					var recipes = recipeResult.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								recipes: $author$project$Main$Success(recipes)
							}),
						$elm$core$Platform$Cmd$none);
				}
		}
			...
			[
				...
				_List_fromArray(
					[
						...
						'/recipes/' + $elm$core$String$fromInt(recipe.id))
					]),
				_List_fromArray(
					[
	...
	switch (_v0.$) {
		case 'Failure':
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text('No recipes could be loaded.')
					]));
		case 'Loading':
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$Main$viewLink('/recipes'),
